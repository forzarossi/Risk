...
public class createHouses {
    ...
    public house createStark(){
        ...
        try {
            ...
            sr.add(new region("Winterfell", 15, Arrays.asList(3, 4, 11), 300, Color, ImageIO.read(new File("resources/regions/winterfell.png")),196,69));
...
//            sr.add(new region("Casterly Rock", 15, Arrays.asList(19, 21), 30, Color, ImageIO.read(new File("resourcegrs/regions/casterlyrock.png"))));
...
//
    public house createGreyjoy(){
        ...
        try {
            sr.add(new region("Pyke", 15, Arrays.asList(15, 38), 50, Color, ImageIO.read(new File("resources/regions/pyke.png")),26,529));
...
//            sr.add(new region("Crackclaw Point", 15, Arrays.asList(25,26), 50, Color, ImageIO.read(new File("resources/regions/crackclaw.png"))));
